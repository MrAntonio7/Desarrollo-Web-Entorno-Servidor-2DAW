...
<div>
     ...
     * Recuerda que las palabras rimarán independientemente de que se escriban con mayúsculas o minúsculas.
     */
    $casa = "casa";
    $masa = "pasa";
    if (strcasecmp(substr($casa, -3), substr($masa, -3)) == 0) {
        echo "Riman";
    } elseif (strcasecmp(substr($casa, -2), substr($masa, -2)) == 0) {
        echo "Riman un poco";
    } else {
        echo "No riman";
    }
...
<div>
     ...
     * A continuación muestra un array cuyas claves sean todas las letras contenidas en la frase y valor el número de
     * veces que aparece esa letra.
     */
    ...
    echo "<p>La frase \"'$frase_b'\" tiene $contadorLetraA a.</p>";
    $arrayLetras = array();
